...
INSERT INTO `carteleras` VALUES (85,60,5,35,'2021-05-28','11:01:00',0),(86,47,5,34,'2021-05-27','11:01:00',0),(87,47,7,34,'2021-05-27','14:46:00',1),(88,47,5,34,'2021-05-28','11:01:00',1),(89,48,7,34,'2021-05-28','13:46:00',1),(90,60,14,34,'2021-05-28','17:21:00',1);
...
INSERT INTO `horarios` VALUES (5,'09:00:00',0),(6,'11:00:00',0),(7,'12:45:00',0),(8,'11:45:00',0),(9,'08:00:00',1),(10,'18:31:00',0),(11,'14:00:00',0),(13,'22:50:00',1),(14,'15:20:00',0),(15,'13:00:00',0),(16,'09:01:00',0);
...
INSERT INTO `peliculas` VALUES (47,'Bob Esponja al rescate','bob.jpg','2020-11-06','02:01:00','Cuando su mejor amigo Gary es secuestrado, Bob Esponja se emprende con Patricio en una loca misión lejos de Fondo de Bikini para salvar a su mascota',1,2,0),(48,'Camino hacia el terror 5','aa.png','2020-08-05','01:01:00','camino hacia el terror ',1,2,0),(60,'Camino hacia el terror 6','camino.jpg','2020-09-01','02:01:00','Camino hacia el terror ',1,1,0),(61,'bob esponja','bob.jpg','2019-05-10','02:18:00','asdfg',1,0,1);
...
INSERT INTO `personas` VALUES (18,'Rafael Antonio','Gonzalez Portillo','05408734-7',0),(19,'GENERICO','GENERICO','0',0),(20,'Jacqueline Jasmin','Robles Galdamez','06507687-7',0),(21,'GENERICO','GENERICO','0',0);
...
INSERT INTO `precios` VALUES (56,9.00,48,0,0),(57,4.50,48,1,1),(58,5.85,48,2,0),(59,4.50,48,3,0),(63,6.00,47,0,1),(64,3.00,47,1,1),(65,3.90,47,2,1),(66,3.00,47,3,0),(107,4.00,60,0,0),(108,2.60,60,2,0),(109,2.00,60,3,0),(110,9.00,61,0,1),(111,4.50,61,1,1),(112,5.85,61,2,1),(113,4.50,61,3,0);
...
INSERT INTO `productos` VALUES (8,'coca 355ml',0.60,44,6,0),(9,'coca zero 355ml',1.00,40,6,0),(10,'Coca lite 355ml',1.00,45,6,0),(11,'Fanta 355ml',1.00,44,6,0),(12,'Cascada Uva 355ml',0.75,32,7,0),(13,'Fanta 355ml',1.00,34,6,0),(14,'Salvacola 355ml',7.75,54,7,0),(15,'Uva 355ml',1.00,34,6,0),(16,'Colashanpan',0.75,32,7,0),(17,'Cantaros',5.00,1,8,0);
...
INSERT INTO `proveedores` VALUES (6,'Industria la constancia','2222-8080','Avenida independencia, #526 San Salvador El Salvador',0),(7,'Enbotelladora la cascada','2234-0000','29 Calle Oriente, San Salvador',0),(8,'Tienda la bendicion','2209876','cascascaxaCC',0);
...
INSERT INTO `roles` VALUES (10,'rafa','3c9909afec25354d551dae21590bb26e38d53f2173b8d3dc3eee4c047e7ab1c1eb8b85103e3be7ba613b31bb5c9c36214dc9f14a42fd7a2fdb84856bca5c44c2',2,18,0),(11,'generico','bdc247a1a0e28a586ed40744d281993d519abe981aaef33277d4877d167e1150816e9723d068a59509991ed0cdd8c5cea0f9ecd0ef23664db7cb85db5a0dbe12',2,19,0),(12,'jasmin','3c9909afec25354d551dae21590bb26e38d53f2173b8d3dc3eee4c047e7ab1c1eb8b85103e3be7ba613b31bb5c9c36214dc9f14a42fd7a2fdb84856bca5c44c2',0,20,0),(13,'generico','bdc247a1a0e28a586ed40744d281993d519abe981aaef33277d4877d167e1150816e9723d068a59509991ed0cdd8c5cea0f9ecd0ef23664db7cb85db5a0dbe12',2,21,1),(14,'rafta','3c9909afec25354d551dae21590bb26e38d53f2173b8d3dc3eee4c047e7ab1c1eb8b85103e3be7ba613b31bb5c9c36214dc9f14a42fd7a2fdb84856bca5c44c2',0,18,0);
...
where  b.Nombre like concat("%",pNombre,"%") and a.fecha=pFecha  group by a.idCarteleras order by c.HoraInicio asc ;
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `SP_REGISTROADMIN` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_REGISTROADMIN`(
pNombres varchar(45),
...
pDUI, 0);
set id =(select last_insert_id());
insert into roles (Usuario,Pasword,TipoRol,Id_Persona, Estado) values (pUser,sha2(pPass,512),0,id,0);
...
-- Dump completed on 2021-05-28  9:42:26
