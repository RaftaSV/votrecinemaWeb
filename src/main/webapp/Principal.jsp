...
<body>
	...
	<script type="text/javascript">
		...
		function proveedores() {
			var link = "http://localhost:8181/Votre/Proveedores.jsp"
			iframe.remove();
		...
		function Facturar() {
			var link = "http://localhost:8181/Votre/Facturar.jsp"
			iframe.remove();
			iframe.frameBorder = 0;
			iframe.width = "100%";
			iframe.height = "98%";
		...
		function peliculas() {
			var link = "http://localhost:8181/Votre/Peliculas.jsp"
			iframe.remove();
			iframe.frameBorder = 0;
			iframe.width = "100%";
			iframe.height = "98%";
		...
		function productos() {
			var link = "http://localhost:8181/Votre/Productos.jsp"
			iframe.remove();
			iframe.frameBorder = 0;
			iframe.width = "100%";
			iframe.height = "98%";
		...
		function salas() {
			var link = "http://localhost:8181/Votre/Salas.jsp"
				iframe.remove();
			iframe.frameBorder = 0;
			iframe.width = "100%";
			iframe.height = "98%";
		...
		function personas() {
			var link = "http://localhost:8181/Votre/personas.jsp"
				iframe.remove();
			iframe.frameBorder = 0;
			iframe.width = "100%";
			iframe.height = "98%";
	...
	function Horerios() {
		var link = "http://localhost:8181/Votre/Horarios.jsp"
		iframe.remove();
		iframe.frameBorder = 0;
		iframe.width = "100%";
		iframe.height = "98%";
	...
	function Roles() {
		var link = "http://localhost:8181/Votre/rol.jsp"
		iframe.remove();
		iframe.frameBorder = 0;
		iframe.width = "100%";
		iframe.height = "98%";
	...
	function Carteleras() {
		var link = "http://localhost:8181/Votre/Carteleras.jsp"
		iframe.remove();
		iframe.frameBorder = 0;
		iframe.width = "100%";
		iframe.height = "98%";
